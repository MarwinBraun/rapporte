...
require('mc_table.php');
    ...
    and Status = 60 and convert(date, MontJourn.Termin) >= '".$zeitraumvon."' and convert(date, MontJourn.Termin) <= '".$zeitraumbis."'
    and MontJourn.MontJournID IN ($plode) order by MontJourn.Termin desc";
